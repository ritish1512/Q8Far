...
export type StorageHash =
  StorageHashBase<'201e44bfdbfcf4dbe34ce81fc1c1fb1d8a42507fef07d0f277425f98ddfd7b2b'>;
export type ExecutionHash =
  ExecutionHashBase<'527a59d007439625d4fe4cb2a1916d881cebc12efc4b31a61a20f33ff7f53bf3'>;
...
export type FieldOutputTypes = {
  readonly public: {
    ...
    readonly Booking: {
      ...
      readonly cropId: CodecTypes['pg/text@1']['output'];
    ...
    readonly Crop: {
      ...
      readonly ussdCode: CodecTypes['pg/text@1']['output'];
      readonly currentBasePrice: CodecTypes['pg/float8@1']['output'];
      readonly maxMoisturePct: CodecTypes['pg/float8@1']['output'];
      readonly createdAt: CodecTypes['pg/timestamptz-string@1']['output'];
      readonly updatedAt: CodecTypes['pg/timestamptz-string@1']['output'];
    };
...
export type FieldInputTypes = {
  readonly public: {
    ...
    readonly Booking: {
      ...
      readonly cropId: CodecTypes['pg/text@1']['input'];
    ...
    readonly Crop: {
      ...
      readonly ussdCode: CodecTypes['pg/text@1']['input'];
      readonly currentBasePrice: CodecTypes['pg/float8@1']['input'];
      readonly maxMoisturePct: CodecTypes['pg/float8@1']['input'];
      readonly createdAt: CodecTypes['pg/timestamptz-string@1']['input'];
      readonly updatedAt: CodecTypes['pg/timestamptz-string@1']['input'];
    };
    readonly ProcurementCenter: {
        ...
        readonly entries: {
          readonly table: {
            ...
            readonly booking: {
              ...
              indexes: readonly [
                {
                  readonly name: 'booking_cropId_idx_879e8d63';
                  readonly prefix: 'booking_cropId_idx';
            ...
            readonly centerOnCrops: {
              ...
              primaryKey: { readonly columns: readonly ['centerId', 'cropId'] };
              uniques: readonly [];
              indexes: readonly [
                {
                  readonly name: 'centerOnCrops_centerId_idx_57ced294';
                  readonly prefix: 'centerOnCrops_centerId_idx';
                  readonly columns: readonly ['centerId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'centerOnCrops_cropId_idx_879e8d63';
                  readonly prefix: 'centerOnCrops_cropId_idx';
                  readonly columns: readonly ['cropId'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'centerOnCrops';
                    readonly columns: readonly ['centerId'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
            ...
            readonly crop: {
              columns: {
                ...
                readonly currentBasePrice: {
                  readonly nativeType: 'float8';
                  readonly codecId: 'pg/float8@1';
                  readonly nullable: false;
                };
                readonly maxMoisturePct: {
                  readonly nativeType: 'float8';
                  readonly codecId: 'pg/float8@1';
                  readonly nullable: false;
                  readonly default: {
                    readonly kind: 'literal';
                    readonly value: DefaultLiteralValue<'pg/float8@1', 14>;
                  };
                };
                readonly createdAt: {
                  readonly nativeType: 'timestamptz';
              ...
              uniques: readonly [
                ...
                { readonly columns: readonly ['ussdCode'] },
              ];
              indexes: readonly [];
              foreignKeys: readonly [];
            };
        ...
        readonly models: {
          ...
          readonly Booking: {
            ...
            readonly relations: {
              ...
              readonly crop: {
                readonly to: { readonly namespace: 'public' & NamespaceId; readonly model: 'Crop' };
                readonly cardinality: 'N:1';
                readonly on: {
                  readonly localFields: readonly ['cropId'];
                  readonly targetFields: readonly ['id'];
                };
              };
              readonly schedule: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly cropId: { readonly column: 'cropId' };
          ...
          readonly Crop: {
            ...
            readonly relations: {
              readonly bookings: {
                ...
                readonly on: {
                  ...
                  readonly targetFields: readonly ['cropId'];
                };
              };
              readonly centerCrops: {
                readonly to: {
                  readonly namespace: 'public' & NamespaceId;
                  readonly model: 'CenterOnCrops';
                };
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly ussdCode: { readonly column: 'ussdCode' };
                readonly currentBasePrice: { readonly column: 'currentBasePrice' };
                readonly maxMoisturePct: { readonly column: 'maxMoisturePct' };
                readonly createdAt: { readonly column: 'createdAt' };
                readonly updatedAt: { readonly column: 'updatedAt' };
              };
            };
